...
public class TagController extends BaseController implements IGenericController<Tag> {
    ...
    public ResponseEntity<List<Tag>> getAll() {
        try {
            ...
            throw new CustomException("Aucun tag trouvé", HttpStatus.NOT_ACCEPTABLE, null);
        }    }
    ...
    public ResponseEntity<Tag> save(Tag entity) {
        try {
            ...
            throw new CustomException("Tag non modifié/créé", HttpStatus.NOT_ACCEPTABLE, null);
        }
    }
